...
class LocationResourceIT {
    ...
    private static final String DEFAULT_LANDMARK_NAME = "AAAAAAAAAA";
    private static final String UPDATED_LANDMARK_NAME = "BBBBBBBBBB";
    ...
    public static Location createEntity(EntityManager em) {
        Location location = new Location()
            ...
            .landmarkName(DEFAULT_LANDMARK_NAME)
    ...
    public static Location createUpdatedEntity(EntityManager em) {
        Location location = new Location()
            ...
            .landmarkName(UPDATED_LANDMARK_NAME)
    ...
    void getAllLocations() throws Exception {
        ...
        restLocationMockMvc
            ...
            .andExpect(jsonPath("$.[*].landmarkName").value(hasItem(DEFAULT_LANDMARK_NAME)))
    ...
    void getLocation() throws Exception {
        ...
        restLocationMockMvc
            ...
            .andExpect(jsonPath("$.landmarkName").value(DEFAULT_LANDMARK_NAME))
