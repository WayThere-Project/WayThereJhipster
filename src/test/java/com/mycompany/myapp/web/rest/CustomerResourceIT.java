...
class CustomerResourceIT {
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer().customerID(DEFAULT_CUSTOMER_ID).fname(DEFAULT_FNAME).lname(DEFAULT_LNAME).dob(DEFAULT_DOB);
        return customer;
    }
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer().customerID(UPDATED_CUSTOMER_ID).fname(UPDATED_FNAME).lname(UPDATED_LNAME).dob(UPDATED_DOB);
        return customer;
    }
    ...
    void putExistingCustomer() throws Exception {
        ...
        updatedCustomer.customerID(UPDATED_CUSTOMER_ID).fname(UPDATED_FNAME).lname(UPDATED_LNAME).dob(UPDATED_DOB);
    ...
    void partialUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.customerID(UPDATED_CUSTOMER_ID).lname(UPDATED_LNAME).dob(UPDATED_DOB);
    ...
    void fullUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.customerID(UPDATED_CUSTOMER_ID).fname(UPDATED_FNAME).lname(UPDATED_LNAME).dob(UPDATED_DOB);
