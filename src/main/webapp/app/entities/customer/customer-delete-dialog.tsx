...
export const CustomerDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="wayThereJhipsterApp.customer.delete.question">
        <Translate contentKey="wayThereJhipsterApp.customer.delete.question" interpolate={{ id: customerEntity.id }}>
