...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './rate.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RATE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RATE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RATE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RATE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RATE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RATE actions', async () => {
      const arg = 42666;
