...
export const ReservationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="wayThereJhipsterApp.reservation.delete.question">
        <Translate contentKey="wayThereJhipsterApp.reservation.delete.question" interpolate={{ id: reservationEntity.id }}>
