...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './insurance.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSURANCE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INSURANCE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INSURANCE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INSURANCE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INSURANCE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INSURANCE actions', async () => {
      const arg = 42666;
