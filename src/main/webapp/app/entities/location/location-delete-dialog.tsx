...
export const LocationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="wayThereJhipsterApp.location.delete.question">
        <Translate contentKey="wayThereJhipsterApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
