...
export const PaymentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="wayThereJhipsterApp.payment.delete.question">
        <Translate contentKey="wayThereJhipsterApp.payment.delete.question" interpolate={{ id: paymentEntity.id }}>
